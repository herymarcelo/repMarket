...
<template>
  <div>
    <Head title="Bienvenidos a Market" />

    <!-- Navbar -->
    <nav class="bg-gradient-to-r from-indigo-500 to-sky-900 p-4">
      <div class="container mx-auto flex justify-between items-center">
        <!-- Logo o nombre de la aplicación -->
        <a href="#" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Market</a>
  ...
  <!-- Hero Sections -->
  <section class="bg-gray-100 p-16 text-center flex flex-col items-center">
  <div class="overflow-hidden drop-shadow-2xl saturate-100 backdrop-brightness-150 bg-gray/30 skew-y-12 rounded">
    <img class="h-auto rounded scale-75 transition-opacity duration-500 ease-in-out transform hover:opacity-100" 
         src="asset/img/2.png" alt="image description">
  </div>
  <h1 class="text-4xl font-bold my-4">Servicios</h1>
  <p class="text-gray-700">A description of the third hero section.</p>
  </section>


  <section class="bg-gray-200 p-16 text-center">
  <h1 class="text-4xl font-bold mb-4">Productos</h1>
  <p class="text-gray-700">A description of the first hero section.</p>

  <!-- Cards Section -->
  <div class="flex justify-center mt-8 space-x-16">
    <!-- Card 1 -->
    <div class="max-w-xs bg-white rounded-lg overflow-hidden shadow-md">
      <img src="https://via.placeholder.com/300" alt="Product Image" class="w-full h-48 object-cover object-center">
      <div class="p-8">
        <h2 class="text-xl font-semibold mb-2">Producto 1</h2>
    ...
    <div class="max-w-xs bg-white rounded-lg overflow-hidden shadow-md">
      <img src="https://via.placeholder.com/300" alt="Product Image" class="w-full h-48 object-cover object-center">
      <div class="p-8">
        <h2 class="text-xl font-semibold mb-2">Producto 2</h2>
    ...
    <div class="max-w-xs bg-white rounded-lg overflow-hidden shadow-md">
      <img src="https://via.placeholder.com/300" alt="Product Image" class="w-full h-48 object-cover object-center">
      <div class="p-8">
        <h2 class="text-xl font-semibold mb-2">Producto 3</h2>
    ...
    <section class="bg-gray-400 p-16 text-center">
      <h1 class="text-4xl font-bold mb-4">Nosotros</h1>
      <p class="text-gray-700">A description of the third hero section.</p>
    </section>

    <section class="bg-gray-500 p-16 text-center">
      <h1 class="text-4xl font-bold mb-4">Contáctanos</h1>
      <p class="text-gray-700">A description of the fourth hero section.</p>
    </section>

    <section class="bg-gray-600 p-16 text-center text-white">
      <h1 class="text-4xl font-bold mb-4">Mercado</h1>
      <p class="text-gray-200">A description of the fifth hero section.</p>
    </section>

    <!-- Form Section -->
    <section class="bg-gray-900 text-white p-16">
    ...
    <!-- Hero Sections Redes-->
    <section class="bg-gray-900 p-16 text-center text-white">
